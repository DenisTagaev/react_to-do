...
export default function NotFound() {
  return (
    <>
      <div className="nfBackground">
      <Header/>
        <div className="nfGround"></div>
      </div>
      <div className="nfContainer">
        <div className="nfLeft-section">
          <div className="nfInner-content">
            <h1 className="nfHeading">404</h1>
            <p className="nfSubheading">
              Looks like the page you were looking for is no longer here.
            </p>
          </div>
        </div>
        <div className="nfRight-section">
          <svg
            className="NFsvgimg"
